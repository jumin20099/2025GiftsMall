...
<head>
    ...
    <title>GIFTS:Mall - All Products</title>
</head>
...
<body>
    <div class="video-container">
        ...
        <div class="controls">
            ...
            <button id="rewind">되감기</button>
            <button id="fast-forward">빨리감기</button>
            <button id="slow-down">감속</button>
            <button id="speed-up">배속</button>
            <button id="reset-speed">배속 원래대로</button>
            <button id="toggle-controls">컨트롤러 숨기기</button>
            <button id="toggle-loop">반복 켜기</button>
            <button id="toggle-autoplay">자동재생 켜기</button>
        </div>
    </div>

    <h2>건강식품</h2>
    <div id="health-food-container" class="all-products-container">
        <div class="all-products popular">
            <img src="../선수제공파일/A-Module/images/건강식품/1.PNG" alt="건강식품 인기상품">
            <h4>이뮨 멀티비타민&미네랄</h4>
            <h4>국내 판매 1위 멀티비타민 이뮨 14일분에 이중제형 + 남/녀 맞춤설계 포뮬러를 적용한 신제품</h4>
            <p><span>75,000원</span> 65,000원 (세일)</p>
        ...
        <div class="all-products">
            <img src="../선수제공파일/A-Module/images/건강식품/5.PNG" alt="">
            <h4>네이처메이드B12</h4>
            <h4>여성 건강을 생각하는 23가지 주요 비타민&미네랄, 한국인 1일 영양 권장량을 고려한 철분, 엽산이 강화된 여성종합비타민</h4>
            <p>가격 30,000원</p>
            <p>일반배송 2,500원 (20,000원 이상 무료배송)</p>
            <p>결제혜택 GIFTS카드 추가 10% 할인</p>
            <p>GiftsMall 포인트 최대 1% 적립</p>
    ...
    <h2>디지털</h2>
    <div id="digital-container" class="all-products-container">
        <div class="all-products popular">
            <img src="../선수제공파일/A-Module/images/디지털/4.jpg" alt="디지털 인기상품">
            <h4>파이널마우스 스타라이트12 페가수스 미디엄</h4>
            <h4>최첨단 펌웨어를 갖춘 업계 최고의 노르딕 RF 플랫폼 기반의 무선 기술 채용, 최대 20,000CPI 해상도를 갖춘 e스포츠 센서 채용</h4>
            <p><span>1,254,000원</span> 1,128,600원 (세일)</p>
        ...
        <div class="all-products">
            <img src="../선수제공파일/A-Module/images/디지털/5.PNG" alt="">
            <h4>보이저5200 블루투스 이어폰</h4>
            <h4>4개의 마이크 탑재, 6중 바람차단, 강력한 노이즈 캔슬링, 공간의 소음을 최대로 줄여 최적의 업무 환경을 경험할 수 있습니다.</h4>
            <p>가격 146,000원</p>
            <p>일반배송 2,500원 (20,000원 이상 무료배송)</p>
            <p>결제혜택 GIFTS카드 추가 10% 할인</p>
            <p>GiftsMall 포인트 최대 1% 적립</p>
    ...
    <h2>팬시</h2>
    <div id="fancy-container" class="all-products-container">
        <div class="all-products popular">
            <img src="../선수제공파일/A-Module/images/팬시/4.PNG" alt="">
            <h4>게이밍 이어폰 VJJB NI</h4>
            <h4>세계 1위 가성비 유선 이어폰. 듀얼 드라이버 기술로 완벽한 고품질 사운드와 교체가 가능한 분리형 커스텀 케이블</h4>
            <p><span>38,900원</span> 28,900원 (세일)</p>
            <p>일반배송 2,500원 (20,000원 이상 무료배송)</p>
            <p>결제혜택 GIFTS카드 추가 10% 할인</p>
            <p>GiftsMall 포인트 최대 1% 적립</p>
            <div class="buttons">
        ...
        <div class="all-products">
            <img src="../선수제공파일/A-Module/images/팬시/5.PNG" alt="">
            <h4>인스탁스 미니 에보</h4>
            <h4>당신이 보는 세상을 보여주세요. 가장 혁신적인 프리미엄 클래식 하이브리드 카메라, 묵직한 세련됨이 돋보이는 mini Evo의 클래식 디자인을 만나보세요.</h4>
            <p>가격 320,000원</p>
            <p>일반배송 3,000원 (20,000원 이상 무료배송)</p>
            <p>결제혜택 GIFTS카드 추가 10% 할인</p>
            <p>GiftsMall 포인트 최대 1% 적립</p>
    ...
    <h2>향수</h2>
    <div id="perfume-container" class="all-products-container">
        <div class="all-products popular">
            <img src="../선수제공파일/A-Module/images/향수/4.PNG" alt="">
            <h4>몽블랑 익스플로러 EDP 60ml</h4>
            <h4>전 세계를 여행하는 탐험가의 향기. 에너제틱 베르가못에서 자연스러운 패출리로 이어지는 향의 여정(우디 레더리 아로마틱)</h4>
            <p><span>103,000원</span> 93,000원 (세일)</p>
            <p>일반배송 2,500원 (20,000원 이상 무료배송)</p>
            <p>결제혜택 GIFTS카드 추가 10% 할인</p>
            <p>GiftsMall 포인트 최대 1% 적립</p>
            <div class="buttons">
        ...
        <div class="all-products">
            <img src="../선수제공파일/A-Module/images/향수/5.PNG" alt="">
            <h4>캘빈클라인 One EDT 50ml</h4>
            <h4>남녀 모두에게 어울리는 현대적이며, 라이트한 향의 캘빈클라인 CK one 오 드 뚜왈렛. 상쾌하고 신선한 시트러스 계열의 향으로 편안하고 캐주얼한 향수</h4>
            <p>가격 58,900원</p>
            <p>일반배송 2,500원 (20,000원 이상 무료배송)</p>
            <p>결제혜택 GIFTS카드 추가 10% 할인</p>
            <p>GiftsMall 포인트 최대 1% 적립</p>
    ...
    <h2>헤어케어</h2>
    <div id="hair-care-container" class="all-products-container">
        <div class="all-products popular">
            <img src="../선수제공파일/A-Module/images/헤어케어/5.PNG" alt="">
            <h4>닥터포헤어 피토프레시 헤어쿨링 스프레이 150ml</h4>
            <h4>열받아 예민해진 두피를 위한 즉각적인 두피 쿨링 솔루션. 온종일 느껴지는 상쾌함, 피토프레이 쿨링 스프레이</h4>
            <p><span>16,000원</span> 14,400원 (세일)</p>
            <p>일반배송 2,500원 (20,000원 이상 무료배송)</p>
            <p>결제혜택 GIFTS카드 추가 10% 할인</p>
            <p>GiftsMall 포인트 최대 1% 적립</p>
            <div class="buttons">
        ...
        <div class="all-products">
            <img src="../선수제공파일/A-Module/images/헤어케어/4.PNG" alt="">
            <h4>모로칸오일 헤어트리트먼트 100ml</h4>
            <h4>헤어케어, 컨디셔닝, 스타일링, 피니시까지 모두 가능한 단 하나의 헤어 오일 트리트먼트</h4>
            <p>가격 52,200원</p>
            <p>일반배송 2,500원 (20,000원 이상 무료배송)</p>
            <p>결제혜택 GIFTS카드 추가 10% 할인</p>
            <p>GiftsMall 포인트 최대 1% 적립</p>
    ...
    <div>
        <button id="guestOrderBtn">비회원 주문</button>
    </div>
    ...
    <div id="modal" class="modal-overlay">
        <div class="modal-content">
            <h2>비회원 주문</h2>
            <div id="member-info">
                <p>비회원 ID: <span id="guestId"></span></p>
            </div>
            <h3>전시 영역</h3>
            <div id="exhibit">
                <!-- 상품 목록 -->
                <div class="product" draggable="true">
                    <div>
                        <img src="../선수제공파일/공통/images/03.jpg" alt="상품 1">
                    </div>
                    <p>상품 1</p>
                    <p>가격: 10000원</p>
                </div>
                <div class="product" draggable="true">
                    <img src="../선수제공파일/공통/images/04.jpg" alt="상품 1">
                    <p>상품 2</p>
                    <p>가격: 5000원</p>
                </div>
                <div class="product" draggable="true">
                    <img src="../선수제공파일/공통/images/05.jpg" alt="상품 1">
                    <p>상품 3</p>
                    <p>가격: 8000원</p>
                </div>
            </div>
            ...
            <div id="payment">
                <h3>결제 영역</h3>
                <p>총 결제 금액: <span id="totalAmount">0</span> 원</p>
            </div>
